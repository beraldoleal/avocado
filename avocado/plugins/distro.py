...
class Distro(CLICmd):
    ...
    def _get_output_file_name(self):
        ...
        """
        name = settings.get('distro', 'distro_def_name')
        version = settings.get('distro', 'distro_def_version')
        release = settings.get('distro', 'distro_def_release')
        arch = settings.get('distro', 'distro_def_arch')
    ...
    def run(self, config):
        ...
        release = settings.get('distro', 'distro_def_release')
        arch = settings.get('distro', 'distro_def_arch')
        distro_type = settings.get('distro', 'distro_def_type')
        path = settings.get('distro', 'distro_def_path')
        if settings.get('distro', 'distro_def_create'):
