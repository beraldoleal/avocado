...
class List(CLICmd):
    ...
    def run(self, config):
        references = settings.get('nlist', 'references')
        verbose = settings.get('nlist', 'verbose')
        ...
        recipes_directory = settings.get('nlist.recipes', 'write_to_directory')
